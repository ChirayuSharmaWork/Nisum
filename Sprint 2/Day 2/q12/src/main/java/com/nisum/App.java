...
public class App {
    public static void main(String[] args) {
        ...
        String genderAngNames = employees.stream().collect(Collectors.groupingBy(Employee::getGender,Collectors.mapping(Employee::getFirstName,Collectors.joining("-")))).entrySet().stream().map(e -> e.getKey() + ": [" + e.getValue() + "]").collect(Collectors.joining(" , "));

        System.out.println(genderAngNames);
