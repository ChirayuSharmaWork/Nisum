...
public class App {
    public static void main(String[] args) {
        ...
        String fullNameAndDepartment = employees.stream().skip(7).findFirst().map(e -> "Name : " + e.getFirstName() + " " + e.getLastName() + " Department : " + e.getDepartment()).orElse("NO employee found ");

        System.out.println(fullNameAndDepartment);
//       Consumer<List<String>> print = list -> list.forEach(e -> System.out.println(e));
//       print.accept(fullName);
