...
public class App {
    public static void main(String[] args) {
        ...
        List<Employee> employees = List.of(
                ...
                new Employee(103,"1234", "Bob", "Brown", "MALE", "Finance", 70000, Optional.empty(), Optional.empty()),
        ...
        List<Employee> newEmployess = employees.stream().map(e -> {
            String paddedId = String.format("%04d", Integer.parseInt(e.getStoreId()));
            e.setStoreId(paddedId);
            return e;
        }).collect(Collectors.toList());

        Consumer<List<Employee>> print = list -> list.forEach(e -> System.out.println(e.getStoreId()));
        print.accept(newEmployess);
