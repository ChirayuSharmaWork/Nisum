...
public class App {
    public static void main(String[] args) {
        ...
        List<Integer> empID = List.of(101,105,110);
        List<Employee> matchedEmployees = employees.stream().filter(e -> empID.contains(e.getEmpId())).collect(Collectors.toList());

        Consumer<List<Employee>> print = list -> list.forEach(e -> System.out.println(e));

        print.accept(matchedEmployees);
