...
public class App {
    public static void main(String[] args) {
        ...
        List<Employee> salaryOrder = employees.stream().sorted(Comparator.comparing(e -> e.getSalary())).collect(Collectors.toList());

        Consumer<List<Employee>> nameAndSalary = list -> list.forEach(e -> System.out.println(e.getFirstName() + " " + e.getLastName() + "  salary : " + e.getSalary()));

        nameAndSalary.accept(salaryOrder);
