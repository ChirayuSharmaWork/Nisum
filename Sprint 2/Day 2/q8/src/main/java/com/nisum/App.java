...
public class App {
    public static void main(String[] args) {
       ...
       List<String> fullName = employees.stream().map(e -> e.getFirstName() + " " + e.getLastName()).collect(Collectors.toList());
       Consumer<List<String>> print = list -> list.forEach(e -> System.out.println(e));
       print.accept(fullName);


//        System.out.println(highestEmpId.getFirstName() + " " + highestEmpId.getLastName());
