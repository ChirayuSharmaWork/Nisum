...
public class App {
    public static void main(String[] args) {
        ...
        List<Employee> noDepartment = employees.stream().filter(e -> !e.getDepartment().equalsIgnoreCase(department)).collect(Collectors.toList());

        Consumer<List<Employee>> printList = list -> list.forEach(e -> System.out.println(e.getFirstName() + " " + e.getLastName()));
        printList.accept(noDepartment);
