...
public class App {
    public static void main(String[] args) {
        ...
        Map<String,Long> groupByGender = employees.stream().collect(Collectors.groupingBy(
                Employee::getGender,
                Collectors.counting()
        ));

        Consumer<Map<String,Long>> print = map -> map.forEach((key,value) -> System.out.println(key + " : " + value) );
        print.accept(groupByGender);
