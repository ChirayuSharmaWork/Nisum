...
public class App {
    public static void main(String[] args) {
        ...
        List<Employee> sortByFirstName = employees.stream().sorted(Comparator.comparing(Employee::getFirstName)).collect(Collectors.toList());
        Consumer<List<Employee>> print = list -> list.forEach(e -> System.out.println(e.getFirstName()));
        print.accept(sortByFirstName);
